...
BDCSVD<MatrixType>& BDCSVD<MatrixType>::compute(const MatrixType& matrix, unsigned int computationOptions) 
{
  ...
  {
    //  this line involves temporaries
  ...
  m_naiveU.setZero();
  m_naiveV.setZero();
  //  this line involves a temporary matrix
...
void BDCSVD<MatrixType>::copyUV(const HouseholderU &householderU, const HouseholderV &householderV, const NaiveU &naiveU, const NaiveV &naiveV)
{
  ...
  if (computeU())
  {
    ...
    householderU.applyThisOnTheLeft(m_matrixU); //  this line involves a temporary buffer
  }
  if (computeV())
  {
    ...
    householderV.applyThisOnTheLeft(m_matrixV); //  this line involves a temporary buffer
  }
}
...
//
//  Opportunities for optimization: better root finding algo, better stopping criterion, better
...
//  deflation44 is still broken and not properly tested
template <typename MatrixType>
