...
//  this should better be moved to NumTraits
...
struct expm1_impl<std::complex<RealScalar> > {
  EIGEN_DEVICE_FUNC static inline std::complex<RealScalar> run(
    ...
    //  better use numext::expm1 and numext::sin (but that would require forward declarations or moving this specialization down).
