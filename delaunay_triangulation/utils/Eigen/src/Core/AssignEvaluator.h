...
private:
  ...
  //  distinguish between linear traversal and inner-traversals
...
{
  // : this is not very clean, perhaps this information should be provided by the kernel?
...
struct unaligned_dense_assignment_loop<false>
{
  ...
  // packet access path.
  //  check which version exhibits this issue
#if EIGEN_COMP_MSVC
  template <typename Kernel>
...
protected:
  ...
  //  find a way to avoid the needs of the original expression
...
void call_assignment_no_alias(Dst& dst, const Src& src, const Func& func)
{
  ...
  //  check whether this is the right place to perform these checks:
...
// : not sure we have to keep that one, but it helps porting current code to new evaluator mechanism.
// Note that the last template argument "Weak" is needed to make it possible to perform
// both partial specialization+SFINAE without ambiguous specialization
template< typename DstXprType, typename SrcXprType, typename Functor, typename Weak>
