...
struct traits<Block<XprType, BlockRows, BlockCols, InnerPanel> > : traits<XprType>
{
  ...
  enum{
    ...
    // , this traits is rather specialized for dense object and it needs to be cleaned further
    FlagsLvalueBit = is_lvalue<XprType>::value ? LvalueBit : 0,
    FlagsRowMajorBit = IsRowMajor ? RowMajorBit : 0,
    Flags = (traits<XprType>::Flags & (DirectAccessBit | (InnerPanel?CompressedAccessBit:0))) | FlagsLvalueBit | FlagsRowMajorBit,
    //  DirectAccessBit should not be handled by expressions
    // 
  ...
  : public internal::dense_xpr_base<Block<XprType, BlockRows, BlockCols, InnerPanel> >::type
{
  ...
  public:
    ...
    // class InnerIterator; //  apparently never used
  ...
  : public MapBase<Block<XprType, BlockRows, BlockCols, InnerPanel> >
{
  ...
  #ifndef __SUNPRO_CC
  //  sunstudio is not friendly with the above friend...
  // META- there is no 'friend' keyword around here. Is this obsolete?
  protected:
  #endif
