...
#ifndef EIGEN_PARSED_BY_DOXYGEN
//  should we keep that possibility
...
//  currently a triangular expression has the form TriangularView<.,.>
...
// : experiment with a recursive assignment procedure splitting the current
