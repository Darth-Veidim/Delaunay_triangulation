  ...
  : public traits<Map<_PlainObjectType, _Options, _StrideType> >
{
  ...
  template<typename Derived> struct match {
    enum {
      ...
      AlignmentMatch = (int(traits<PlainObjectType>::Alignment)==int(Unaligned)) || (DerivedAlignment >= int(Alignment)), //  the first condition is not very clear, it should be replaced by the required alignment
