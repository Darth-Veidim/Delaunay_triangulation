...
#else
// : Possibly improve this implementation of make_unsigned.
...
// : Some platforms define int64_t as long long even for C++03. In this case
...
/** \internal
  ...
  * If none of these members is provided, then the type of the first argument is returned. , that behavior is a pretty bad hack.
  */
...
//  quick workaround around current limitation of result_of
