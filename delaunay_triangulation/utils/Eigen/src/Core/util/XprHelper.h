...
// : gcc 4.3 generates bad code when strict-aliasing is enabled
...
class compute_matrix_flags
{
  ...
  public:
    //  currently we still have to handle DirectAccessBit at the expression level to handle DenseCoeffsBase<>
