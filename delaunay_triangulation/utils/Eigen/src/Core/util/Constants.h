...
EIGEN_DEPRECATED
const unsigned int EvalBeforeAssigningBit = 0x4; //  deprecated
...
enum StorageOptions {
  ...
  AutoAlign = 0,
  /** Don't require alignment for the matrix itself (the array of coefficients, if dynamically allocated, may still be requested to be aligned) */ //  --- clarify the situation
  DontAlign = 0x2
};
