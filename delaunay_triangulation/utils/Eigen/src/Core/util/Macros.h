...
// : could probably be removed as we do not support gcc 3.x anymore
...
// : get rid of EIGEN_HAS_CXX14 and maybe even EIGEN_HAS_CXX11.
...
//  Maybe the EIGEN_DENSE_PUBLIC_INTERFACE could be removed as importing PacketScalar is rarely needed
