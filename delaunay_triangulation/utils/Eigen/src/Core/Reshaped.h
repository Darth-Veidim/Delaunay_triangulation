  ...
  : reshaped_evaluator<ArgType, Rows, Cols, Order, traits<Reshaped<ArgType,Rows,Cols,Order> >::HasDirectAccess>
{
  ...
  // : should check for smaller packet types
  ...
  : evaluator_base<Reshaped<ArgType, Rows, Cols, Order> >
{
  ...
  enum {
    CoeffReadCost = evaluator<ArgType>::CoeffReadCost /*  + cost of index computations */,
                      ...
                      typename Reshaped<ArgType, Rows, Cols, Order>::PlainObject>
{
  ...
  {
    // : for the 3.4 release, this should be turned to an internal assertion, but let's keep it as is for the beta lifetime
