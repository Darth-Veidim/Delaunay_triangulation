...
// (gonnet): Further reduce the interval allowing for lower-degree
...
Packet pexp_float(const Packet _x)
{
  ...
  // (gonnet): Split into odd/even polynomials and try to exploit
...
Packet pexp_double(const Packet _x)
{
  ...
  // (gonnet): Figure out what is going on here, perhaps find a better
