...
{
  //  when EIGEN_USE_BLAS is defined,
  ...
  //  the transpose variable is only needed to properly split
  ...
  double kMinTaskSize = 50000;  //  improve this heuristic.
  ...
  //  omp_get_num_threads()>1 only works for openmp, what if the user does not use openmp?
