  ...
  RhsScalar alpha)
{
  ...
  // : for padded aligned inputs, we could enable aligned reads
  ...
  // : improve the following heuristic:
  ...
  ResScalar alpha)
{
  ...
  // : fine tune the following heuristic. The rationale is that if the matrix is very large,
