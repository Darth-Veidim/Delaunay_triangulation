  ...
  : public EigenBase<SparseSelfAdjointView<MatrixType,_Mode> >
{
  public:
    ...
    //  implement twists in a more evaluator friendly fashion
...
struct Assignment<DstXprType, SrcXprType, Functor, SparseSelfAdjoint2Sparse>
{
  ...
  // : the handling of += and -= in sparse matrices should be cleanup so that next two overloads could be reduced to:
...
// : maybe the copy could be handled by generic_product_impl so that these overloads would not be needed anymore
